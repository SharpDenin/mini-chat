...
const docTemplate = `{
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_dto.SetAdminStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/room_member": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Id's пользователя и комнаты",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_dto.CreateRoomMemberRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "api_dto.CreateRoomMemberRequest": {
            "type": "object",
            "required": [
                "room_id",
                "user_id"
